...
**ACIT4220-MorningMessage** is a morning greeting package developed as a part of the ACIT4420 course and mandatory assigment. The package includes four python files which includes contact_manager.py, message_generator.py, message_sender.py and logger.py. Additonaly the program has a __main__.py entrypoint, an __init__ file to mark it as module, a log_message.txt file for logging and a JSON file were the contacts are stored.
## Table of Contents
- [Features](#features)
